...
public class GameApplicationGL extends CommonApplicationGL {
	...
	@Override
	public void load() {
	  hand = new Mesh(MeshLoader.getInstance().loadModel("player/hand/rhand_decim.obj"));
	  hand.setColor(new Color(0xFF,0xC3,0xAA));
	  hand.setZ(-0.8);
	  hand.setX(0.3);
	  hand.setY(-0.5);
	  hand.setScale(0.6f);
	...
	public GUIEvent updateKeyboard(KeyEvent event) {
		...
		if(event.isKeyUp(KeyEvent.TSK_ESC)) {
			activeCenterMouse = !activeCenterMouse;
		}
	...
	public GUIEvent updateMouse(PointerEvent event) {
		...
		mouse.updateMouse(parent, event);
